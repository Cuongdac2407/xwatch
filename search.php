            ...
            <div class="container">
                <div class="row align-items-center py-3">
                    ...
                    <div class="col-lg-6 col-6 text-left search-inner">
                        <form action="timkiem.php" class="w-100 position-relative" method="post">
                        ...
                        <nav class="navbar navbar-expand-lg bg-gray-900 navbar-light py-3 py-lg-0 px-0">
                            ...
                            <div class="collapse navbar-collapse" id="navbarCollapse">
                                <div class="navbar-nav mr-auto py-0 w-100 d-flex justify-content-center">
                                    ...
                                    <a href="men_watch.php" class="nav-item nav-link position-relative text-uppercase  mx-4">Đồng hồ nam</a>
                                    <a href="women_watch.php" class="nav-item nav-link position-relative text-uppercase  mx-4">Đồng hồ nữ</a>
...
if(isset($_POST['timkiem'])){
    ...
    echo "số sản  phẩm trùng tên là :$tukhoa ";
}
?>   
             <div class="mb-5 sanpham_search">
    ...
    <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
        <div class="card product-item border-0 mb-4" data-index="1">
            <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                    ...
                    <img class="product-thumbnail img-fluid w-100" src="./img/'.$row["img1"].'" alt="">
                </a>
            </div>
            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                <h6 class="product-name text-truncate mb-3">'.$row["tensanpham"].'</h6>
                <div class="d-flex justify-content-center">
                    <h6 class="text-muted"><del>'.$row["giaban"].'</h6><h6 class="product-price ml-2">'.$row["giagiam"].' ₫</h6>
                </div>
            </div>
            <div class="card-footer d-flex justify-content-between bg-light border">
                <a href="./detail.php?sel='.$row["id"].'" class="btn btn-sm text-dark p-0"><i class="fas fa-eye text-primary mr-1"></i>Xem chi tiết</a>
                <a type="button" class="btn btn-sm btn-add-cart text-dark p-0"><i class="fas fa-shopping-cart text-primary mr-1"></i>Thêm vào giỏ</a>
            </div>
        </div>    
</div>
';
