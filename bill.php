...
if(isset($_POST['dongydathang']) && ($_POST['dongydathang'])){
 for ($i=0; $i < sizeof($_SESSION['cart']) ; $i++) { 
                  $tensanpham=$_SESSION['cart'][$i][0];
                  $giaban=$_SESSION['cart'][$i][1];
                  $soluong=$_SESSION['cart'][$i][2];
                  $tongtien=$giaban *  $soluong;
                  taodonhang($tensanpham,$giaban,$soluong,$tongtien);
    ...
    <div class="container-fluid pt-5">
        <div class="row px-xl-5">    
            <div class="col-lg-8 table-responsive mb-5">
                <table id="listSanPham" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="table table-striped table-bordered text-center mb-0 display">
